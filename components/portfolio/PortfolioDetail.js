            ...
            <div className='p-3' >
                ...
                <div className='flex justify-between items-center mt-8'>
                    ...
                    <div className="flex items-center space-x-5">
                        {portfolio.github && <a href={portfolio.github} rel="noreferrer" target="_blank" className="ring-0 text-gray-800 outline-none dark:invert invert-0">
                            <FaGithub size={18} />
                        </a>}
                        {portfolio.link && <a href={portfolio.link} rel="noreferrer" target="_blank" className="ring-0 text-gray-800 outline-none dark:invert invert-0">
                            <FaGlobe size={18} />
                        </a>}
                    </div>
                </div>
